...
and get your own API key. You will be able to complete this exercise in our
UI without doing so, as we have provided a sample result.
...
- list of dictionaries, where the dictionary key is "section" and value
is "title" - list of URLs for all media entries with
...
def save_file(kind, period):
    ...
    # supplied offset value, combine the data and then write all results
    # in a file.
