...
def parse_file(datafile):
    ...
    data['maxvalue'] = max(sheet.col_values(1, start_rowx=1))

    data['minvalue'] = min(sheet.col_values(1, start_rowx=1))

    data['avgcoast'] = sum(sheet.col_values(1, start_rowx=1)) / \
        len(sheet.col_values(1, start_rowx=1))
